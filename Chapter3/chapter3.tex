...
On google maps, with a scale of 20 meters as shown in the image, this 
is the location. 
...
\begin{itemize}
    ...
    \item[-] Air quality sensor: sensor of the brand \code{SPEC SENSORS} specifically the model \href{https://www.spec-sensors.com/wp-content/uploads/2016/10/ULPSM-IAQ-968-008.pdf}{ULPSM-IAQ}. It measures the indoor air quality   with very low power consumption and the output signal in this case is analog.
